...
SP_API void _spSetMalloc (void* (*_spMalloc) (size_t size));
SP_API void _spSetDebugMalloc (void* (*_spMalloc) (size_t size, const char* file, int line));
SP_API void _spSetRealloc(void* (*_spRealloc) (void* ptr, size_t size));
SP_API void _spSetFree (void (*_spFree) (void* ptr));
