...
public:
	...
	virtual float SkeletonLayerOpacity(size_t index) const noexcept = 0;
	virtual bool SetSkeletonLayerOpacity(size_t index, float opacity) noexcept = 0;
	virtual SlColor SkeletonLayerTint(size_t index) const noexcept = 0;
	virtual bool SetSkeletonLayerTint(size_t index, const SlColor& color) noexcept = 0;
	virtual SlColor SkeletonLayerLerpTint(size_t index) const noexcept = 0;
	virtual bool SetSkeletonLayerLerpTint(size_t index, const SlColor& color) noexcept = 0;
